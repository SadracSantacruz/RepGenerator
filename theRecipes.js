...
// The latino Reps - food
let caldoRes = new RepCreator(
  latino,
  latino.food,
  new OrderRep(
    "Caldo de Res",
...
let aguaDePepino = new RepCreator(
  latino,
  latino.drinks,
  new OrderRep("Agua de Pepino", [
...
let aguaDeSandia = new RepCreator(
  latino,
  latino.drinks,
  new OrderRep(
    "Agua de Sandia",
